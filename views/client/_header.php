                ...
                <div class="d-flex">
                    ...
                    <div class="d-flex order-lg-2 ml-auto">
                        <div class="nav-item d-none d-md-flex">
                            <a href="../home/index.php" class="btn btn-sm btn-outline-primary" target="_blank">برگشت به صفحه اول</a>
                        </div>
                      ...
                      <small class="text-muted d-block mt-1">کاربر</small>
                    </span>
                            </a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                                <a href="index.php" class="nav-link">سفارشات من</a>
                            </li>
