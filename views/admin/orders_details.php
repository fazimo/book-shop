<?php include_once ('_header.php') ?>
    ...
    <div class="container">
        ...
        <div class="col-12">
            ...
            <a href="orders_accept.php?id=<?php print($id); ?>" class="btn btn-success"> <i class="fa fa-check"> </i>تائید سفارش</a>
            <a href="orders_reject.php?id=<?php print($id); ?>" class="btn btn-danger"> <i class="fa fa-reply"> </i>لغو سفارش</a>
        </div>
    </div>
